...
func (app *application) readString(qs url.Values, key string,
...
func (app *application) readInt(qs url.Values, key string,
...
// background is a helper function that accepts an arbitrary function as a
// parameter.
