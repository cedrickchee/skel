...
func main() {
	...
	// Parse the JWT signing secret from the command-line-flag. Notice that we
	// leave the default value as the empty string if no flag is provided.
